simulate_corr = function(n_trts, n_burn_cycles, burn_obvs_per_period,
                        adaptive_obvs_per_period, max_duration,
                        betas, y_sigma, priors, n_chains, n_iter, lag, phi,
                        stabilize = NULL,
                        objective = "Maximize",
                        adapt_delta = 0.999,
                        max_treedepth = 15,
...
test = simulate_corr(n_trts=3,
                     n_burn_cycles=1,
                     burn_obvs_per_period=5,
                     adaptive_obvs_per_period=5,
                     max_duration=10,
                     betas=c(130, 0, 0),
                     y_sigma=10,
